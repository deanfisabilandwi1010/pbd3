    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Transaksi Re-Stok Barang</h5>
              ...
              <table class="table">
                ...
                <button class="btn btn-primary" onclick="location.href= ' ../inventoris/input_restok_inventori.php'" type="button" style="float: right" >Add</button>
