...
$query = pg_query($conn, "SELECT max(id_pegawai) as id_pegawai FROM pegawai");
        ...
        <form method="POST" class="d-flex">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" name="id_pegawai" value="<?php echo $id?>" class="form-control" maxlength="10" readonly />
                    </div>
                </div>
